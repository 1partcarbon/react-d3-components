...
var DataSet = React.createClass({
    ...
    render: function render() {
         ...
         */
        var rect = ReactDOMServer.renderToString(React.createElement("rect", { width: width, height: height }));
...
var LineChart = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                Chart,
                { height: height, width: width, style: style, margin: margin, style: style },
